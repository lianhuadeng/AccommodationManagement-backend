...
CREATE TABLE `application` (
  ...
  `applier_id` bigint DEFAULT NULL COMMENT '申请人学号',
  ...
  `opinion` varchar(200) DEFAULT NULL COMMENT '审核意见',
  PRIMARY KEY (`application_id`),
  KEY `application_user_user_id_fk` (`applier_id`),
...
CREATE TABLE `park` (
  ...
  PRIMARY KEY (`park_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='园区';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `repair` (
  ...
  `status` enum('待分配','待维修','已维修') DEFAULT NULL COMMENT '维修状态',
  `repair_item` varchar(50) DEFAULT NULL COMMENT '维修物品内容',
  ...
  `picture_url` varchar(100) DEFAULT NULL COMMENT '图片',
